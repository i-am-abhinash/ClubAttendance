...
const Layout = ({ children, title, description }) => {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-theme-bg text-theme-text font-sans relative overflow-x-hidden">
      ...
      <header className="h-[88px] w-full flex items-center justify-between px-6 lg:px-10 border-b border-theme-border-subtle bg-white/70 backdrop-blur-md sticky top-0 z-30">
        ...
        <div className="flex items-center gap-5 shrink-0">
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="w-10 h-10 rounded-full bg-theme-accent-light text-theme-accent flex items-center justify-center font-bold text-sm border border-theme-accent/20">
